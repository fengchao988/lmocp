...
import com.snszyk.iiot.marketization.market.domain.marketelement.TransactionScopeConverterListJson;
...
public class MarketElement implements Serializable {
    ...
    /*@OneToMany(cascade = CascadeType.ALL,
            mappedBy = "marketElementId", orphanRemoval = true,fetch = FetchType.EAGER)*/
